...
interface LeaveEventSheetProps {
  visible: boolean;
  onClose: () => void;
  onLeave: () => void;
  isLoading?: boolean;
...
export function LeaveEventSheet({
  visible,
  onClose,
  onLeave,
  isLoading = false,
}: LeaveEventSheetProps) {
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.contentContainer}>
        ...
        >
          Are you sure you want to leave this Secret Santa event? You won't be able to rejoin unless the organizer invites you again.
        </Text>
