...
interface MarkCompleteConfirmSheetProps {
  visible: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isLoading?: boolean;
...
export function MarkCompleteConfirmSheet({
  visible,
  onClose,
  onConfirm,
  isLoading = false,
}: MarkCompleteConfirmSheetProps) {
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.contentContainer}>
        ...
        >
          Has the gift exchange happened? This will end the event and notify all participants.
        </Text>
