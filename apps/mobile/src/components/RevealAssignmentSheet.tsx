...
interface RevealAssignmentSheetProps {
  visible: boolean;
  onClose: () => void;
  onReveal: () => void;
  isLoading?: boolean;
...
export function RevealAssignmentSheet({
  visible,
  onClose,
  onReveal,
  isLoading = false,
}: RevealAssignmentSheetProps) {
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.contentContainer}>
        ...
        >
          Ready to find out who you're buying a gift for? Once revealed, you'll see their name and can view their wishlist.
        </Text>
          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                <Text style={styles.confirmButtonText}>Reveal!</Text>
              </>
            )}
          </TouchableOpacity>
        </View>
